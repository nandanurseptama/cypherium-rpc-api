...
In this case, `cypher` would be started with `--externalsigner=http://localhost:8550` and would relay requests to `cph.sendTransaction`.
...
The signer will generate a new private key, encrypts it according to [web3c keystore spec](https://github.com/cypherium/wiki/wiki/Web3c-Secret-Storage-Definition) and stores it in the keystore directory.
...
#### Import account
   Import a private key into the keystore. The imported key is expected to be encrypted according to the web3c keystore
   format.
   
#### Arguments
  - account [object]: key in [web3c keystore format](https://github.com/cypherium/wiki/wiki/Web3c-Secret-Storage-Definition) (retrieved with account_export) 
...
#### Result
  - exported key, see [web3c keystore format](https://github.com/cypherium/wiki/wiki/Web3c-Secret-Storage-Definition) for
  more information
