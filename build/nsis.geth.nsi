...
# 1. install cypher for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for cypher
# 5. create cypher, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable Cphereum_SOCKET
...
!define GROUPNAME "Cypherium"
!define APPNAME "Cypher"
!define DESCRIPTION "Official Go implementation of the Cypherium protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since cypher is installed global
