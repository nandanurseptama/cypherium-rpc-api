...
const (
	...
	MessageType_MessageType_CphereumGetAddress       MessageType = 56
	MessageType_MessageType_CphereumAddress          MessageType = 57
	MessageType_MessageType_CphereumSignTx           MessageType = 58
	MessageType_MessageType_CphereumTxRequest        MessageType = 59
	MessageType_MessageType_CphereumTxAck            MessageType = 60
	...
	MessageType_MessageType_CphereumSignMessage      MessageType = 64
	MessageType_MessageType_CphereumVerifyMessage    MessageType = 65
	MessageType_MessageType_CphereumMessageSignature MessageType = 66
...
var MessageType_name = map[int32]string{
	...
	56:  "MessageType_CphereumGetAddress",
	57:  "MessageType_CphereumAddress",
	58:  "MessageType_CphereumSignTx",
	59:  "MessageType_CphereumTxRequest",
	60:  "MessageType_CphereumTxAck",
	61:  "MessageType_GetECDHSessionKey",
	62:  "MessageType_ECDHSessionKey",
	63:  "MessageType_SetU2FCounter",
	64:  "MessageType_CphereumSignMessage",
	65:  "MessageType_CphereumVerifyMessage",
	66:  "MessageType_CphereumMessageSignature",
...
var MessageType_value = map[string]int32{
	...
	"MessageType_CphereumGetAddress":       56,
	"MessageType_CphereumAddress":          57,
	"MessageType_CphereumSignTx":           58,
	"MessageType_CphereumTxRequest":        59,
	"MessageType_CphereumTxAck":            60,
	"MessageType_GetECDHSessionKey":        61,
	"MessageType_ECDHSessionKey":           62,
	"MessageType_SetU2FCounter":            63,
	"MessageType_CphereumSignMessage":      64,
	"MessageType_CphereumVerifyMessage":    65,
	"MessageType_CphereumMessageSignature": 66,
...
// *
// Request: Ask device for Cypherium address corresponding to address_n path
// @next PassphraseRequest
// @next CphereumAddress
// @next Failure
type CphereumGetAddress struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	ShowDisplay      *bool    `protobuf:"varint,2,opt,name=show_display,json=showDisplay" json:"show_display,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *CphereumGetAddress) Reset()                    { *m = CphereumGetAddress{} }
func (m *CphereumGetAddress) String() string            { return proto.CompactTextString(m) }
func (*CphereumGetAddress) ProtoMessage()               {}
func (*CphereumGetAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{22} }

func (m *CphereumGetAddress) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *CphereumGetAddress) GetShowDisplay() bool {
	if m != nil && m.ShowDisplay != nil {
		return *m.ShowDisplay
	}
	return false
...
// *
// Response: Contains an Cypherium address derived from device private seed
// @prev CphereumGetAddress
type CphereumAddress struct {
	Address          []byte `protobuf:"bytes,1,req,name=address" json:"address,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *CphereumAddress) Reset()                    { *m = CphereumAddress{} }
func (m *CphereumAddress) String() string            { return proto.CompactTextString(m) }
func (*CphereumAddress) ProtoMessage()               {}
func (*CphereumAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{24} }

func (m *CphereumAddress) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
// @next PassphraseRequest
// @next PinMatrixRequest
// @next CphereumTxRequest
// @next Failure
type CphereumSignTx struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Nonce            []byte   `protobuf:"bytes,2,opt,name=nonce" json:"nonce,omitempty"`
...
func (m *CphereumSignTx) Reset()                    { *m = CphereumSignTx{} }
func (m *CphereumSignTx) String() string            { return proto.CompactTextString(m) }
func (*CphereumSignTx) ProtoMessage()               {}
func (*CphereumSignTx) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{49} }

func (m *CphereumSignTx) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *CphereumSignTx) GetNonce() []byte {
	if m != nil {
		return m.Nonce
	}
	return nil
...
func (m *CphereumSignTx) GetGasPrice() []byte {
	if m != nil {
		return m.GasPrice
	}
	return nil
...
func (m *CphereumSignTx) GetGasLimit() []byte {
	if m != nil {
		return m.GasLimit
	}
	return nil
...
func (m *CphereumSignTx) GetTo() []byte {
	if m != nil {
		return m.To
	}
	return nil
...
func (m *CphereumSignTx) GetValue() []byte {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *CphereumSignTx) GetDataInitialChunk() []byte {
	if m != nil {
...
func (m *CphereumSignTx) GetDataLength() uint32 {
...
func (m *CphereumSignTx) GetChainId() uint32 {
...
func (m *CphereumTxRequest) Reset()                    { *m = CphereumTxRequest{} }
func (m *CphereumTxRequest) String() string            { return proto.CompactTextString(m) }
func (*CphereumTxRequest) ProtoMessage()               {}
func (*CphereumTxRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{50} }

func (m *CphereumTxRequest) GetDataLength() uint32 {
	if m != nil && m.DataLength != nil {
		return *m.DataLength
	}
	return 0
...
func (m *CphereumTxRequest) GetSignatureV() uint32 {
...
func (m *CphereumTxRequest) GetSignatureR() []byte {
	if m != nil {
		return m.SignatureR
	}
	return nil
...
func (m *CphereumTxRequest) GetSignatureS() []byte {
	if m != nil {
		return m.SignatureS
	}
	return nil
...
// @prev CphereumTxRequest
// @next CphereumTxRequest
type CphereumTxAck struct {
	DataChunk        []byte `protobuf:"bytes,1,opt,name=data_chunk,json=dataChunk" json:"data_chunk,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *CphereumTxAck) Reset()                    { *m = CphereumTxAck{} }
func (m *CphereumTxAck) String() string            { return proto.CompactTextString(m) }
func (*CphereumTxAck) ProtoMessage()               {}
func (*CphereumTxAck) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{51} }

func (m *CphereumTxAck) GetDataChunk() []byte {
	if m != nil {
		return m.DataChunk
	}
	return nil
...
// *
// Request: Ask device to sign message
// @next CphereumMessageSignature
// @next Failure
type CphereumSignMessage struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Message          []byte   `protobuf:"bytes,2,req,name=message" json:"message,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *CphereumSignMessage) Reset()                    { *m = CphereumSignMessage{} }
func (m *CphereumSignMessage) String() string            { return proto.CompactTextString(m) }
func (*CphereumSignMessage) ProtoMessage()               {}
func (*CphereumSignMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{52} }

func (m *CphereumSignMessage) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *CphereumSignMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// @next Success
// @next Failure
type CphereumVerifyMessage struct {
...
func (m *CphereumVerifyMessage) Reset()                    { *m = CphereumVerifyMessage{} }
func (m *CphereumVerifyMessage) String() string            { return proto.CompactTextString(m) }
func (*CphereumVerifyMessage) ProtoMessage()               {}
func (*CphereumVerifyMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{53} }

func (m *CphereumVerifyMessage) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *CphereumVerifyMessage) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *CphereumVerifyMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// *
// Response: Signed message
// @prev CphereumSignMessage
type CphereumMessageSignature struct {
	Address          []byte `protobuf:"bytes,1,opt,name=address" json:"address,omitempty"`
	Signature        []byte `protobuf:"bytes,2,opt,name=signature" json:"signature,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *CphereumMessageSignature) Reset()                    { *m = CphereumMessageSignature{} }
func (m *CphereumMessageSignature) String() string            { return proto.CompactTextString(m) }
func (*CphereumMessageSignature) ProtoMessage()               {}
func (*CphereumMessageSignature) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{54} }

func (m *CphereumMessageSignature) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *CphereumMessageSignature) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*CphereumGetAddress)(nil), "CphereumGetAddress")
	proto.RegisterType((*Address)(nil), "Address")
	proto.RegisterType((*CphereumAddress)(nil), "CphereumAddress")
	...
	proto.RegisterType((*CphereumSignTx)(nil), "CphereumSignTx")
	proto.RegisterType((*CphereumTxRequest)(nil), "CphereumTxRequest")
	proto.RegisterType((*CphereumTxAck)(nil), "CphereumTxAck")
	proto.RegisterType((*CphereumSignMessage)(nil), "CphereumSignMessage")
	proto.RegisterType((*CphereumVerifyMessage)(nil), "CphereumVerifyMessage")
	proto.RegisterType((*CphereumMessageSignature)(nil), "CphereumMessageSignature")
